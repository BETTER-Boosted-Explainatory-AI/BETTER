...
from services.dendrogram_service import _get_sub_dendrogram, _rename_cluster, _get_common_ancestor_subtree
...
async def get_common_ancestor_subtree(sub_dendrogram_data: DendrogramRequest, current_user: User = Depends(require_authenticated_user)) -> DendrogramResult:
    model_id = sub_dendrogram_data.model_id
    graph_type = sub_dendrogram_data.graph_type
    selected_labels = sub_dendrogram_data.selected_labels
